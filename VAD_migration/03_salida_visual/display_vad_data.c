 ...
 * $Author: jeffs $
 * $Locker:  $
 * $Date: 2015/03/24 19:17:47 $
 * $Id: display_vad_data.c,v 1.5 2015/03/24 19:17:47 jeffs Exp $
 * $Revision: 1.5 $
 * $State: Exp $
 */
...
static	int	pixel1; /* shared pixel coordinate data */
static	int	scanl1; /* shared scanline coordinate data */
