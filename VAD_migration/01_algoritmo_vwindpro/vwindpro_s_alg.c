...
/* $Author: jeffs $ */
/* $Locker:  $ */
/* $Date: 2015/04/10 13:42:28 $ */
/* $Id: vwindpro_s_alg.c,v 1.6 2015/04/10 13:42:28 jeffs Exp $ */
/* $Revision: 1.6 $ */
/* $State: Exp $ */
        ...
        if( (c_elv >= 0) && (c_ht >= 0) ){
            ...
            if( replace_wind ){
                ...
                for( k = 0; k < MAX_NUM_AMBRNG; k++ ){
                    ...
                    A317ve->ambig_range[k][c_ht] = A317vs->ambig_range[c_ht][c_elv][k];
                    A317ve->ambig_azlim[k][c_ht] = A317vs->ambig_azlim[c_ht][c_elv][k];
