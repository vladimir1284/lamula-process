 ...
 * $Author: jeffs $
 * $Locker:  $
 * $Date: 2015/03/26 15:15:51 $
 * $Id: vwindpro_prod.c,v 1.7 2015/03/26 15:15:51 jeffs Exp $
 * $Revision: 1.7 $
 * $State: Exp $
 */
...
int A31831_vad_prod( float *htg_ewt, float *rms_ewt, float *hwd_ewt, 
    ...
    int lensab, maxdir, lenpsd, bptr, offpsd;
...
/*\/////////////////////////////////////////////////////////////////////
   ...
   Inputs:
      ...
      lensab - adaptation data block length, in bytes.
...
int A3183f_vad_alpha_winds( int beg, int *end, short *vadbuf, int i4date, 
    ...
    /* Get the VCP.  Used to get elevation angle. */
